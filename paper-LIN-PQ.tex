...
%\vspace{-6pt}
\begin{definition}[data-independence of priority queue]\label{def:priority-value data-independence}
...
%The following lemma states that the inductive rules for priority queues are sound and complete.
