...
The following lemma states the correctness of $\textit{Check-PQ-Seq}$ (the proof can be found in Appendix~\ref{}). {\color {blue}Therefore, in latter section we can abuse $\seqPQ$ by the set obtained by renaming sequences that are accepted by $Check-PQ-Seq$.} 
